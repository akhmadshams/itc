...
from apps.finance.views import InListView
...
urlpatterns = [
    ...
    path('favicon.ico', RedirectView.as_view(url=staticfiles_storage.url('plugins/logo.png')))
]
